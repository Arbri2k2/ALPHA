...
<html>
  <head>
    ...
    <title>ALPHA GYM MS | Admin login</title>
  </head>
  <body>
    ...
    <section class="login-content">
      <div class="logo">
        <h1>ALPHA GYM MS | Admin login</h1>
      </div>
      <div class="login-box">
        <form class="login-form" method="post">
          <h3 class="login-head"><i class="fa fa-lg fa-fw fa-user"></i>HYR</h3>
  ...
  <!--             <p class="semibold-text mb-2"><a href="#" data-toggle="flip">Forgot Password ?</a></p> -->
          ...
          <div class="form-group btn-container">
            ...
            <input type="submit" name="submit" id="submit" value="HYR" class="btn btn-primary btn-block">
          </div>
          <hr />
