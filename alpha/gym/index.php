		...
		<div class="container">
			<div class="row">
				<div class="col-lg-7 m-auto text-white">
					<h2>Kryesore</h2>
					<p>Ushtrimet fizike permirsojne shendetin!</p>
				</div>
			</div>
		</div>
	</section>
	...
	<section class="pricing-section spad">
		<div class="container">
			<div class="section-title text-center">
				...
				<h2>Cmimet</h2>
				<p>Praktiko YOGA dhe zbukuro pamjen fizike!</p>
			</div>
			<div class="row">
				        <?php 
...
?>
				<div class="col-lg-3 col-sm-6">
					<div class="pricing-item begginer">
						...
						<a href="login.php" class="site-btn sb-line-gradient">Abonohu Tani</a>
						<?php else :?>
                        ...
                        <input class='site-btn sb-line-gradient' type='submit' name='submit' value='Abonohu' onclick="return confirm('Deshiron te abonohesh per kte pakete?.');"> 
                        </form> 
							 <?php endif;?>
					</div>
				</div>
