	<header class="header-section">
				...
				<div class="col-md-6 text-left text-md-right p-0">
                 <?php if(strlen($_SESSION['uid'])==0): ?>
					<div class="header-info d-none d-md-inline-flex">
						...
						<a href="login.php"><p>HYR</p></a>
					</div>
					<?php else :?>
					<div class="header-info d-none d-md-inline-flex">
						<i class="material-icons">account_circle</i>
						<a href="profile.php"><p>Profili</p></a>
					</div>
					<div class="header-info d-none d-md-inline-flex">
						<i class="material-icons">brightness_7</i>
						<a href="changepassword.php"><p>Ndrysho Fjalekalimin</p></a>
					</div>
					<div class="header-info d-none d-md-inline-flex">
		...
		<div class="header-bottom">
			<a href="index.php" class="site-logo" style="color:#fff; font-weight:bold; font-size:26px;">
				ALPHA GYM<br />
				<small style="margin-top:-4%;">ALPHA Gym Management System</small>
			</a>
			...
			<li><a href="admin/">Admini</a></li>
					<?php else :?>
						<li><a href="booking-history.php">Historia e Abonimeve</a></li>
						<?php endif;?>
				</ul>
			</div>
		</div>
