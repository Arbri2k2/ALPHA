...
if($lastInsertId>0)
{
echo "<script>alert('Rregjistrim i sukseshem, mund te logoheni!');</script>";
echo "<script> window.location.href='login.php';</script>";
}
else 
{
$error ="Rregjistrimi nuk u be!";
 }
}
 }
	...
	<section class="contact-page-section spad overflow-hidden">
		<div class="container">
			...
			<div class="row">
                ...
                else if($succmsg){?><div class="succWrap"><strong>SUKSES</strong>:<?php echo htmlentities($succmsg); ?> </div><?php }?><br><br>
